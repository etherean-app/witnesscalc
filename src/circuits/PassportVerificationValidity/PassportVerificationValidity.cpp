...
void Num2Bits_1_run(uint ctx_index, Circom_CalcWit* ctx) {
    ...
    while (Fr_isTrue(&expaux[0])) {
        ...
        if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template/function " << myTemplateName << " line 33. " <<
    ...
    if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template/function " << myTemplateName << " line 38. " <<
                                "Followed trace of components: " << ctx->getTrace(myId) << std::endl;
    assert(Fr_isTrue(&expaux[0]));
    for (uint i = 0; i < 0; i++) {
        uint index_subc = ctx->componentMemory[ctx_index].subcomponents[i];
...
void LessThan_2_run(uint ctx_index, Circom_CalcWit* ctx) {
    ...
    if (!Fr_isTrue(&circuitConstants[2])) std::cout << "Failed assert in template/function " << myTemplateName << " line 90. " <<
                                          "Followed trace of components: " << ctx->getTrace(myId) << std::endl;
...
void PassportVerification_10_run(uint ctx_index, Circom_CalcWit* ctx) {
    ...
    while (Fr_isTrue(&expaux[0])) {
        {
            ...
            {
                PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + (
                                                             (1 * Fr_toInt(&expaux[0])) + 1)];
                // load src
                // end load src
        ...
        Fr_mul(
            &expaux[1],
            &ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 0],
            &signalValues[mySignalStart + 752]
        ); // line circom 41
        ...
        Fr_mul(
            &expaux[1],
            &ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + 0],
            &signalValues[mySignalStart + 752]
        ); // line circom 42
        ...
        Fr_mul(
            &expaux[1],
            &ctx->signalValues[ctx->componentMemory[mySubcomponents[4]].signalStart + 0],
            &signalValues[mySignalStart + 752]
        ); // line circom 43
    ...
    while (Fr_isTrue(&expaux[0])) {
        ...
        Fr_mul(
            &expaux[1],
            &ctx->signalValues[ctx->componentMemory[mySubcomponents[6]].signalStart + 0],
            &signalValues[mySignalStart + 752]
        ); // line circom 64
        ...
        Fr_mul(
            &expaux[1],
            &ctx->signalValues[ctx->componentMemory[mySubcomponents[8]].signalStart + 0],
            &signalValues[mySignalStart + 752]
        ); // line circom 65
        ...
        Fr_mul(
            &expaux[1],
            &ctx->signalValues[ctx->componentMemory[mySubcomponents[10]].signalStart + 0],
            &signalValues[mySignalStart + 752]
        ); // line circom 66
    ...
    if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template/function " << myTemplateName << " line 80. " <<
                                "Followed trace of components: " << ctx->getTrace(myId) << std::endl;
    assert(Fr_isTrue(&expaux[0])); {
        ...
        Fr_mul(
            &expaux[1],
            &ctx->signalValues[ctx->componentMemory[mySubcomponents[14]].signalStart + 0],
            &signalValues[mySignalStart + 759]
        ); // line circom 101
    ...
    if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template/function " << myTemplateName << " line 111. " <<
                                "Followed trace of components: " << ctx->getTrace(myId) << std::endl;
    assert(Fr_isTrue(&expaux[0])); {
    ...
    if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template/function " << myTemplateName << " line 126. " <<
                                "Followed trace of components: " << ctx->getTrace(myId) << std::endl;
    assert(Fr_isTrue(&expaux[0])); {
        PFrElement aux_dest = &lvar[3];
        // load src
