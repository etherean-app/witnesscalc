...
void BabyAdd_18_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void BabyAdd_18_run(uint ctx_index,Circom_CalcWit* ctx);
...
void Point2Bits_Strict_20_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Point2Bits_Strict_20_run(uint ctx_index,Circom_CalcWit* ctx);
void BabyDbl_21_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void BabyDbl_21_run(uint ctx_index,Circom_CalcWit* ctx);
void IsZero_22_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void IsZero_22_run(uint ctx_index,Circom_CalcWit* ctx);
void Multiplexor2_23_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Multiplexor2_23_run(uint ctx_index,Circom_CalcWit* ctx);
void BitElementMulAny_24_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void BitElementMulAny_24_run(uint ctx_index,Circom_CalcWit* ctx);
...
void WindowMulFix_28_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void WindowMulFix_28_run(uint ctx_index,Circom_CalcWit* ctx);
...
void EscalarMulFix_31_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void EscalarMulFix_31_run(uint ctx_index,Circom_CalcWit* ctx);
void EdDSAVerifier_32_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void EdDSAVerifier_32_run(uint ctx_index,Circom_CalcWit* ctx);
void EdDSADocumentVerifier_33_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void EdDSADocumentVerifier_33_run(uint ctx_index,Circom_CalcWit* ctx);
...
BabyAdd_18_run,
Pedersen_19_run,
Point2Bits_Strict_20_run,
BabyDbl_21_run,
IsZero_22_run,
Multiplexor2_23_run,
BitElementMulAny_24_run,
...
EscalarMulFix_31_run,
EdDSAVerifier_32_run,
EdDSADocumentVerifier_33_run };
...
uint get_total_signal_no() {return 46927;}

uint get_number_of_components() {return 3818;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 18296;}
...
for (uint i = 0; i < 2; i++) {
std::string new_cmp_name = "adders"+ctx->generate_position_array(aux_dimensions, 1, i);
BabyAdd_18_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 10 ;
aux_cmp_num += 1;
}
...
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
BabyAdd_18_run(mySubcomponents[cmp_index_ref],ctx);
...
Multiplexor2_23_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 7 ;
aux_cmp_num += 1;
}
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
check(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
Multiplexor2_23_run(mySubcomponents[cmp_index_ref],ctx);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 0];
// load src
...
BitElementMulAny_24_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 29 ;
aux_cmp_num += 4;
}
...
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
BitElementMulAny_24_run(mySubcomponents[cmp_index_ref],ctx);
...
IsZero_22_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 3 ;
aux_cmp_num += 1;
}
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
check(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
IsZero_22_run(mySubcomponents[cmp_index_ref],ctx);
}
{
PFrElement aux_dest = &lvar[3];
// load src
...
for (uint i = 0; i < 83; i++) {
std::string new_cmp_name = "windows"+ctx->generate_position_array(aux_dimensions, 1, i);
WindowMulFix_28_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 95 ;
aux_cmp_num += 9;
}
...
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
WindowMulFix_28_run(mySubcomponents[cmp_index_ref],ctx);
...
Point2Bits_Strict_20_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 2833 ;
aux_cmp_num += 11;
}
...
BabyDbl_21_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 14 ;
aux_cmp_num += 2;
}
...
EscalarMulFix_31_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 9972 ;
aux_cmp_num += 961;
}
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
check(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
Point2Bits_Strict_20_run(mySubcomponents[cmp_index_ref],ctx);
}
{
uint cmp_index_ref = 5;
{
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
check(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
BabyDbl_21_run(mySubcomponents[cmp_index_ref],ctx);
}
{
uint cmp_index_ref = 6;
{
...
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
EscalarMulFix_31_run(mySubcomponents[cmp_index_ref],ctx);
...
uint aux_create = 0;
int aux_cmp_num = 0+ctx_index+1;
uint csoffset = mySignalStart+849;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "edDSAVerifier";
EdDSAVerifier_32_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 46077 ;
aux_cmp_num += 3817;
}
...
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + 257],80);
}
// no need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 80;
check(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter > 0);
}
{
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 336];
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + 337],256);
}
// no need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 256;
check(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter > 0);
...
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 592];
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + 593],256);
}
// need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 256;
check(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
EdDSAVerifier_32_run(mySubcomponents[cmp_index_ref],ctx);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 0];
// load src
...
EdDSADocumentVerifier_33_create(1,0,ctx,"main",0);
EdDSADocumentVerifier_33_run(0,ctx);
}
